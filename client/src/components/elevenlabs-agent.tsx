...
export function ElevenlabsAgent({ figureId }: ElevenlabsAgentProps) {
  ...
  /**
   * Initialize the conversation with ElevenLabs API
   */
  const initializeConversation = () => {
    ...
    try {
      ...
      // This is a workaround for the ElevenLabs SDK TypeScript integration
      import('@11labs/client').then(({ Conversation }) => {
        // Create conversation instance with ElevenLabs SDK
